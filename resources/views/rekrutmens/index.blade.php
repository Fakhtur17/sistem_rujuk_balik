                            ...
                            <form action="{{ route('rekrutmens.index') }}" method="GET">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" name="q" class="form-control border-0 shadow-sm" 
                                           placeholder="🔍 Cari berdasarkan nama peserta atau nomor SEP..." 
                                           value="{{ request('q') }}" 
            ...
            <div class="empty-state-card">
                <div class="card border-0 bg-gradient-light">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted mb-0">Masukkan <strong>Nama Peserta</strong> atau <strong>Nomor SEP</strong> pada kolom pencarian di atas</p>
                    </div>
                </div>
            </div>
        @endif
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-item">
                                            ...
                                            <div class="info-content">
                                                ...
                                                <div class="fw-medium">
                                                    {{ $data->fktp->nama_fktp ?? '-' }} - {{ $data->fktp->kabupaten_kota ?? '' }}
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-item">
                                            ...
                                            <div class="info-content">
                                                <small class="text-muted">FKTL</small>
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-item">
                                            ...
                                            <div class="info-content">
                                                ...
                                                <div>
                                                    <a href="{{ asset('storage/' . $data->link_srb) }}" target="_blank" class="btn btn-sm btn-outline-primary">
                            ...
                            <div class="visit-section mb-4">
                                <div class="section-header">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        @if($user->role === 'fktp' && $user->fktp_id == $data->fktp_id || $user->role === 'admin')
                                    ...
                                    <div class="visit-timeline">
                                        @foreach ($data->kunjunganFktp as $kunjungan)
                                            <div class="visit-item mb-2">
                                                ...
                                                <span class="visit-date d-block">
                                                    Tanggal: {{ \Carbon\Carbon::parse($kunjungan->tanggal_kunjungan)->format('d/m/Y') }}
                                                </span>
                                                <span class="visit-apotek text-muted">
                                                    Apotek: <strong>{{ $kunjungan->apotek->nama_apotek ?? '-' }}</strong>
                                                </span>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="visit-section">
                                <div class="section-header">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        @if($user->role === 'apotek' || $user->role === 'admin')

{{-- resources/views/pic_rs/index.blade.php --}}
<x-app-layout>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 mb-6">
                <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between lg:gap-0">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-800">Daftar PIC RS / Klinik</h1>
                            <p class="text-gray-600">Kelola data Person In Charge Rumah Sakit dan Klinik Utama</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-2">
                        ...
                        @auth
                            @if (auth()->user()->role === 'admin')
                                <a href="{{ route('pic-rs.create', $pic_prb_id) }}" 
                                    ...
                                    <span>Tambah PIC RS/Klinik</span>
                                </a>
                            @endif
                        @endauth
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-gradient-to-r from-blue-100 to-blue-200 border border-blue-300 rounded-xl p-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <div class="font-semibold text-blue-800">Total RS/Klinik</div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    ...
                    <form method="GET" class="mb-4">
                        <div class="flex items-center space-x-3">
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama RS, PIC, atau kota..." 
                        ...
                        <thead class="bg-gradient-to-r from-blue-100 to-cyan-100 border-b border-blue-200">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-sm font-semibold text-blue-800">
                                    <i class="fa fa-hospital mr-1"></i>Nama RS/ Klinik Utama
                                </th>
                                <th class="px-6 py-4 text-left text-sm font-semibold text-blue-800">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500">RS/Klinik PRB</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center space-x-2">
                                            ...
                                            @if(auth()->user() && auth()->user()->role === 'admin')
                                                <!-- Edit Button -->
                                                <a href="{{ route('pic-rs.edit', ['picPrb' => $pic_prb_id, 'id' => $item->id]) }}" 
                                                ...
                                                <!-- Delete Button -->
                                                <form action="{{ route('pic-rs.destroy', ['picPrb' => $pic_prb_id, 'id' => $item->id]) }}" 
                                                    method="POST" 
                                                    class="inline-block"
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center space-y-4">
                                            ...
                                            <div>
                                                <div class="text-lg font-medium text-gray-900">Belum ada data PIC RS/Klinik</div>
                                                <div class="text-sm text-gray-500 mt-1">Klik tombol "Tambah Data" untuk menambahkan PIC RS/Klinik baru</div>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-6">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 class="font-semibold text-blue-800 mb-3">Panduan Pengelolaan Data RS/Klinik</h4>
                            <ul class="text-sm text-blue-700 space-y-2">
                                <li class="flex items-start">
                                    <i class="fa fa-check-circle text-blue-500 mr-2 mt-0.5 text-xs"></i>
                                    <span>Data mencakup Rumah Sakit dan Klinik Utama PRB</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fa fa-check-circle text-blue-500 mr-2 mt-0.5 text-xs"></i>
                                    <span>PIC bertanggung jawab atas koordinasi program PRB</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fa fa-check-circle text-blue-500 mr-2 mt-0.5 text-xs"></i>
                                    <span>Pastikan PIC memiliki kompetensi di bidang PRB</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fa fa-check-circle text-blue-500 mr-2 mt-0.5 text-xs"></i>
                                    <span>Lakukan evaluasi berkala terhadap kinerja PIC</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <span class="text-sm text-cyan-700">Panduan RS/Klinik tersedia di portal</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function confirmDelete(event, rsName) {
            event.preventDefault();
            
            if (confirm(`Apakah Anda yakin ingin menghapus data "${rsName}"?\n\nTindakan ini tidak dapat dibatalkan!`)) {
                event.target.submit();
            }

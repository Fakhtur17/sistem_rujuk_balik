{{-- resources/views/pic_rs/edit.blade.php --}}
<x-app-layout>
        ...
        <div class="container mx-auto px-4 max-w-2xl">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 mb-6">
                <div class="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Edit PIC RS / Klinik</h1>
                        <p class="text-gray-600">Perbarui informasi PIC RS/Klinik Utama yang sudah ada</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                <form action="{{ route('pic-rs.update', ['picPrb' => $data->pic_prb_id, 'id' => $data->id]) }}" method="POST" class="space-y-6">
                    @csrf 
                    @method('PUT')
            ...
            <div class="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-xl mt-6">
                <div class="flex items-center">
                    ...
                    <p class="text-amber-800 text-sm">
                        <strong>Tips:</strong> Perubahan data RS/Klinik akan otomatis tersimpan setelah Anda menekan tombol "Update Data".
                    </p>
                </div>
            </div>
        </div>

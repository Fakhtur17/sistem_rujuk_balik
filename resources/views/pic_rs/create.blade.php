{{-- resources/views/pic_rs/create.blade.php --}}
<x-app-layout>
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
        <div class="container mx-auto px-4 max-w-2xl">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 mb-6">
                <div class="flex items-center space-x-4 mb-6">
                    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 p-3 rounded-xl">
                        <i class="fa fa-hospital-o text-white text-xl"></i>
                    </div>
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Tambah PIC RS / Klinik</h1>
                        <p class="text-gray-600">Tambahkan informasi PIC RS/Klinik Utama yang baru</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                <form action="{{ route('pic-rs.store', $pic_prb_id) }}" method="POST" class="space-y-6">
                    @csrf

                    <!-- Nama RS/Klinik -->
                    <div class="form-group">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            <i class="fa fa-hospital mr-2 text-blue-500"></i>
                            Nama RS/Klinik Utama
                        </label>
                        <div class="relative">
                            <input type="text" 
                                   name="nama_faskes" 
                                   ...
                                   placeholder="Masukkan nama RS/Klinik Utama">
                            @error('nama_faskes') 
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6">
                        ...
                        <a href="{{ route('pic-rs.index', $pic_prb_id) }}" class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3 px-6 rounded-xl transition-all duration-200 text-center">
            ...
            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-xl mt-6">
                <div class="flex items-center">
                    ...
                    <p class="text-blue-800 text-sm">
                        <strong>Tips:</strong> Pastikan data RS/Klinik dan PIC sudah benar sebelum menyimpan. Data ini akan digunakan untuk koordinasi program PRB.
                    </p>
                </div>
            </div>
        </div>
